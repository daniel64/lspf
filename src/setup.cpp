...
main()
{
	...
	ZCTVERB  = "ALOG" ;
	ZCTTRUNC = "3"  ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(AL) SCRNAME(LOG)" ;
	ZCTDESC  = "BROWSE APPLICATION LOG" ;
	p_tableMGR->tbadd( RC, funcPOOL, "ISPCMDS", "", "", 0 ) ;

	ZCTVERB  = "LOG" ;
	ZCTTRUNC = "3"   ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(SL) SCRNAME(LOG)" ;
	ZCTDESC  = "BROWSE LSPF LOG" ;
	p_tableMGR->tbadd( RC, funcPOOL, "ISPCMDS", "", "", 0 ) ;

	ZCTVERB  = "KEYLIST"  ;
	ZCTTRUNC = "0"        ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(KLIST) SCRNAME(KEYLIST)" ;
	ZCTDESC  = "Keylist utility"  ;
	p_tableMGR->tbadd( RC, funcPOOL, "ISPCMDS", "", "", 0 ) ;

	ZCTVERB  = "KEYLISTS" ;
	ZCTTRUNC = "0"        ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(KLISTS) SCRNAME(KEYLIST)" ;
	ZCTDESC  = "Keylist utility"  ;
	p_tableMGR->tbadd( RC, funcPOOL, "ISPCMDS", "", "", 0 ) ;
	...
	ZCTVERB  = "REFACTF" ;
	ZCTTRUNC = "5"       ;
	ZCTACT   = "SELECT PGM(&ZRFLPGM) PARM(PL1 &ZPARM) SCRNAME(REFACT)" ;
	...
	ZCTVERB  = "REFLISTF" ;
	ZCTTRUNC = "4"        ;
	ZCTACT   = "SELECT PGM(&ZRFLPGM) PARM(PL1 REFLIST &ZPARM) SCRNAME(REFLIST)" ;
	ZCTDESC  = "OPEN REFERENCE LIST" ;
	p_tableMGR->tbadd( RC, funcPOOL, "ISPCMDS", "", "", 0 ) ;

	ZCTVERB  = "REFOPENF" ;
	ZCTTRUNC = "4"        ;
	ZCTACT   = "SELECT PGM(&ZRFLPGM) PARM(PL2) SCRNAME(REFOPEN)"  ;
	...
	ZCTVERB  = "ED" ;
	ZCTTRUNC = "0" ;
	ZCTACT   = "SELECT PGM(&ZEDITPGM) NEWAPPL(ISR) PARM(ENTRYPNL) SCRNAME(EDIT)" ;
	ZCTDESC  = "INVOKE EDIT ENTRY PANEL" ;
	p_tableMGR->tbadd( RC, funcPOOL, "USRCMDS", "", "", 0 ) ;

	ZCTVERB  = "BR" ;
	ZCTTRUNC = "0" ;
	ZCTACT   = "SELECT PGM(&ZFLSTPGM) NEWAPPL(ISRB) PARM(BROWSE &ZPARM) SCRNAME(FILES)" ;
	ZCTDESC  = "INVOKE BROWSE" ;
	p_tableMGR->tbadd( RC, funcPOOL, "USRCMDS", "", "", 0 ) ;

	ZCTVERB  = "CMDS" ;
	ZCTTRUNC = "0"    ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(CMDS) SCRNAME(COMMANDS)"  ;
	ZCTDESC  = "SHOW COMMAND TABLES" ;
	p_tableMGR->tbadd( RC, funcPOOL, "USRCMDS", "", "", 0 ) ;

	ZCTVERB  = "TASKS" ;
	ZCTTRUNC = "0"     ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(TASKS) SCRNAME(TASKS)"  ;
	ZCTDESC  = "SHOW TASK LIST" ;
	p_tableMGR->tbadd( RC, funcPOOL, "USRCMDS", "", "", 0 ) ;

	ZCTVERB  = "FLIST" ;
	ZCTTRUNC = "2"     ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(SAVELST) NEWAPPL SCRNAME(SAVED)"  ;
	ZCTDESC  = "SHOW SAVED FILE LIST" ;
	p_tableMGR->tbadd( RC, funcPOOL, "USRCMDS", "", "", 0 ) ;

	ZCTVERB  = "MODS" ;
	ZCTTRUNC = "0"     ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(MODS) SCRNAME(MODULES)"  ;
	ZCTDESC  = "SHOW LOADED DYNAMIC CLASSES" ;
	p_tableMGR->tbadd( RC, funcPOOL, "USRCMDS", "", "", 0 ) ;

	ZCTVERB  = "PATHS" ;
	ZCTTRUNC = "3"     ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(PATHS) SCRNAME(PATHS)"  ;
	...
	ZCTVERB  = "TODO" ;
	ZCTTRUNC = "0"   ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(TODO) NEWAPPL(ISP) SCRNAME(TODO)" ;
	ZCTDESC  = "BROWSE TODO LIST" ;
	p_tableMGR->tbadd( RC, funcPOOL, "USRCMDS", "", "", 0 ) ;

	ZCTVERB  = "VARS" ;
	ZCTTRUNC = "3"    ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(VARS &ZPARM) SCRNAME(VARS)"  ;
	ZCTDESC  = "DISPLAY SHARED & PROFILE VARIABLES" ;
	p_tableMGR->tbadd( RC, funcPOOL, "USRCMDS", "", "", 0 ) ;

	ZCTVERB  = "CUA" ;
	ZCTTRUNC = "0"   ;
	ZCTACT   = "SELECT PGM(PPSP01A) PARM(COLOURS) NEWAPPL(ISP) SCRNAME(CUA)"  ;
