...
void PPSP01A::pfkeySettings()
{
	...
	while ( true )
	{
		...
		{
			ZPF01 = strip( ZPF01 ) ; ZPF02 = strip( ZPF02 ) ; ZPF03 = strip( ZPF03 ) ; ZPF04 = strip( ZPF04 ) ;
			ZPF05 = strip( ZPF05 ) ; ZPF06 = strip( ZPF06 ) ; ZPF07 = strip( ZPF07 ) ; ZPF08 = strip( ZPF08 ) ;
			ZPF09 = strip( ZPF09 ) ; ZPF10 = strip( ZPF10 ) ; ZPF11 = strip( ZPF11 ) ; ZPF12 = strip( ZPF12 ) ;
			ZPF13 = strip( ZPF13 ) ; ZPF14 = strip( ZPF14 ) ; ZPF15 = strip( ZPF15 ) ; ZPF16 = strip( ZPF16 ) ;
			ZPF17 = strip( ZPF17 ) ; ZPF18 = strip( ZPF18 ) ; ZPF19 = strip( ZPF19 ) ; ZPF20 = strip( ZPF20 ) ;
			ZPF21 = strip( ZPF21 ) ; ZPF22 = strip( ZPF22 ) ; ZPF23 = strip( ZPF23 ) ; ZPF24 = strip( ZPF24 ) ;
