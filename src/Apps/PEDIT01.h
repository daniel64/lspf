...
class PEDIT01 : public pApplication
{
        ...
        private:
                ...
                const string BLKcmds   = "CC DD MM HXX LCC MDD MNN OO OOK RR TJJ TXX XX (( )) << >> UCC" ;
                const string SPLcmds   = "A AK B BK C CC COLS D DD F I L M MM MD MDD MN MNN R RR S SI TX TXX X XX XP" ;
                ...
                const string ReptOK    = "C D F HX I L M MD MN O OK R UC LC RR S TJ TX X (( )) ( ) << >> < >" ;
